...
def main():
    ...
    suggestions = ["", "Create a markdown table of the Aurora Energy tenements", "Provide an overview of the Morella ASX announcement.", "Create a markdown table of Morella Corporation lithium assay results.", "What are the highlights of the Aurora Energy Quarterly Report?", "Provide a bullet point list of the key points mentioned in the Alpha HPA report"]
